...
import (
	...
	"github.com/tasuku43/atsura/internal/domain/page"
	"github.com/tasuku43/atsura/internal/domain/sample"
)
...
func TestSampleListRejectsArgumentsBeforeRepository(t *testing.T) {
	...
	if repository.lists != 0 || stdout.Len() != 0 || !strings.Contains(stderr.String(), "usage: atr sample list") {
