...
func legacyTailoringSchemaFault(command, recovery string) error {
	return fault.New(
		...
		false,
		fault.NextAction{Command: recovery, Reason: "Create or validate a schema-5 tailoring specification; no automatic authorization-to-surface conversion is available."},
	)
}
